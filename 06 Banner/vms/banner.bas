...
20 INPUT "VERTICAL";Y
21 INPUT "CENTERED";L$
22 G1=0 \ IF EDIT$(LEFT$(L$,1),32)="Y" THEN G1=1
23 INPUT "CHARACTER (TYPE 'ALL' IF YOU WANT CHARACTER BEING PRINTED)";M$
25 M$=EDIT$(M$,32)  ! convert to uppercase
29 PRINT "STATEMENT";
30 INPUT LINE A$    ! allow user to enter ","
32 A$=EDIT$(A$,32)  ! convert to uppercase
35 INPUT "SET PAGE";O$
40 A=ASC(LEFT$(A$,1))
50 REM
60 REM
...
96 IF P$=" " THEN GOSUB 812 \ GOTO 800
100 IF P$=S$ OR S$="." THEN 200
120 NEXT O
200 RESTORE
201 X$=M$
...
272 IF S(U)=1 THEN F(U)=9-K \ GOTO 445
280 NEXT K
445 FOR T1=1 TO X
...
810 GOTO 999 ! END
812 FOR H=1 TO 7*X \ PRINT \ NEXT H \ RETURN
